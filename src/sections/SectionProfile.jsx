...
const SectionAbout = () => {
    return (
        <div className='flex max-w-4xl mx-auto text-brown-1 lg:px-15 px-10 mb-8'>
            <div className='flex flex-col w-full items-center'>
                <div className='flex flex-col items-center'>
                    <div className='relative'>
                        <div className='relative bg-yellow-1 aspect-square w-full lg:max-w-xs lg:min-w-xs max-w-2xl min-w-2xs rounded-full overflow-clip flex items-end justify-center mb-4 shadow'>

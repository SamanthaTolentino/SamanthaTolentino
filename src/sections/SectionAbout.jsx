        ...
        <div className='flex flex-col items-center'>
            ...
            <div className='flex items-center mb-12'>
                ...
                <div className='grow flex flex-col font-bold'>      
                    ...
                    <p className='text-xl text-pink-1 uppercase mb-1'>Email</p>
                    <p className='font-medium mb-4'>S.Tolentino0828@gmail.com</p>
                    <p className='text-xl text-pink-1 uppercase mb-1'>LinkedIn</p>
                    {/* Make link */}
                    <p className='font-medium mb-4'>www.linkedin.com/in/samanthatolentino/</p>
                    <p className='text-xl text-pink-1 uppercase mb-1'>GitHub</p>
